...
for it in range(1,n_upd):
    _,pred1_tr = forward(x_tr1, gx_tr1, W1n,b1n,Win,Wfn,Won,Wgn,Uin,Ufn,Uon,Ugn,w_finn,b_finn)
    cost_tr1 = loss_measure(pred1_tr,y_tr1,m_tr1) 
    cost_val1 = loss_measure(pred1_tr,y_val1,m_val1) 
    cost_val2 = loss_measure(pred1_tr,y_val2,m_val2)  
    cost = cost_tr1 + l1 * cost_val1 + l2*cost_val2
...
_,pred2_tr = forward(x_tr2, gx_tr2, W1n,b1n,Win,Wfn,Won,Wgn,Uin,Ufn,Uon,Ugn,w_finn,b_finn)
...
gage_feat = preprocessing.scale(gage_feat)
